...
def run_script(userid, amount, username, password):
    ...
    while tries >= 1:
        ...
        try:
            ...
            driver.get("https://www.pandamaster.vip/")
            ...
            if found:
                ...
                iframe_xpath = "//iframe[contains(@src, 'https://www.pandamaster.vip/Module/AccountManager/GrantTreasure.aspx?param=')]"
